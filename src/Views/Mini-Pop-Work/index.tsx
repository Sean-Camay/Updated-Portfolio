          ...
          <div className='flex flex-col ml-4 bg-[#FFFCF9] w-1/2'>
            ...
            <div className='flex flex-row w-lg pb-4'>
              <Typography variant='body1' sx={{ color: 'text.secondary' }}>
                ...
                is a web app synthesizer and sequencer that allows you to create
                a sequence of sounds, change the BPM by tapping or entering a
                value, change key, and create chords.
              </Typography>
            </div>
